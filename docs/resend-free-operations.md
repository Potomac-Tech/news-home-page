...
- Cabeus Council, Pathfinder, Source, UDRI fallback, alerts, and operational forms may use their documented `RESEND_*_TO_EMAIL` override. Without one, they deliver to the default inbox.
