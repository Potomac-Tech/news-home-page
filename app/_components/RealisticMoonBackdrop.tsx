        ...
        <>
            <div className="pointer-events-none absolute inset-0 overflow-hidden">
                <img
                    ...
                    className="absolute right-0 top-1/2 h-auto w-[36rem] max-w-none translate-x-[58%] -translate-y-1/2 opacity-25 sm:w-[min(78rem,100vw)] sm:translate-x-[48%] sm:opacity-[0.88]"
                    fetchPriority="high"
                />
            </div>
