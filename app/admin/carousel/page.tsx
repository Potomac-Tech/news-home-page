            ...
            <div className="mx-auto min-h-[calc(100vh-9rem)] w-full max-w-7xl px-4 py-16 md:px-8">
                ...
                <form action={createCarouselSlide} className="glass-card mt-10 p-6">
                    ...
                    <div className="mt-6 grid gap-5 md:grid-cols-2">
                        ...
                        <label><Label>Minimum tier</Label><select name="minimum_tier" className={inputClass}><option value="public">Public</option><option value="member">Explorer</option><option value="scout">Scout</option><option value="command">Command</option></select></label>
