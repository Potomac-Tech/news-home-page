...
const allFallbackDatasetCatalogEntries: DatasetCatalogEntry[] = [
    ...
    },
    {
        ...
        title: "Cabeus Explorer Lunar Site Intelligence Demo",
        summary:
            "Cabeus Explorer proprietary site-scoring preview that packages public lunar context, operator needs, and proposal-ready location intelligence.",
        ...
        update_frequency: "Preview cadence controlled by Cabeus Explorer analyst review.",
        source_landing_url: "https://potomacdb.com/nexus",
        source_license:
            "Cabeus Explorer proprietary catalog entry; no redistribution without written permission.",
        source_retrieved_at: fallbackRetrievedAt,
        release_target_date: null,
        publication_status: "published",
        published_at: fallbackRetrievedAt,
        ...
        sources: [
            {
                ...
                source_name: "Cabeus Explorer Nexus public product page",
                source_publisher: "Potomac Database Systems",
                source_type: "product",
                source_url: "https://potomacdb.com/nexus",
                citation_text:
                    "Cabeus Explorer public Nexus page describing proprietary lunar site intelligence positioning.",
                license_notes:
                    "Cabeus Explorer proprietary material; no redistribution without written permission.",
                published_at: null,
                retrieved_at: fallbackRetrievedAt,
                is_public: true,
    ...
    },
    {
        ...
        title: "Cabeus Explorer Lunar Economy Benchmark Pack",
        summary:
            "Source-backed Cabeus Explorer benchmark pack for lunar data economics, including the full NASA-paid Firefly Blue Ghost cost basis.",
        ...
        source_license:
            "Cabeus Explorer proprietary derived model; source citations remain visible where licensed or public.",
        source_retrieved_at: fallbackRetrievedAt,
        ...
        sources: [
            {
                ...
                source_name: "Cabeus Explorer lunar economy dashboard reference",
                source_publisher: "Potomac Database Systems",
                source_type: "derived_model",
                source_url: "https://potomacdb.com/member/economy",
                citation_text:
                    "Cabeus Explorer member economy route connected to the Firefly full NASA-paid cost benchmark methodology.",
                license_notes:
                    "Cabeus Explorer proprietary derived model with public-source citations where permitted.",
                published_at: null,
                retrieved_at: fallbackRetrievedAt,
                is_public: true,
                confidence_label: "medium",
    ...
    },
    {
        ...
        title: "Cabeus Explorer Near-Real-Time Polar Volatiles Feed",
        summary:
        ...
        source_license:
            "Cabeus Explorer proprietary placeholder; no redistribution or data access is available.",
        source_retrieved_at: fallbackRetrievedAt,
        release_target_date: null,
        publication_status: "published",
        published_at: fallbackRetrievedAt,
        ...
        sources: [
            {
                ...
                source_name: "Cabeus Explorer near-real-time volatiles placeholder",
                source_publisher: "Potomac Database Systems",
                ...
                license_notes:
                    "Cabeus Explorer proprietary planning record; no source data is distributed.",
                published_at: null,
                retrieved_at: fallbackRetrievedAt,
                is_public: true,
